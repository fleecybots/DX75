...
const vcard = 'BEGIN:VCARD\n'  // Jangan Ganti Kak
            + 'VERSION:3.0\n'  // Jangan Ganti Kak
            + 'FN:Raka\n' //ganti nama mu
            + 'ORG: Pengembang Fleecy Bot;\n' //Ganti Nama Bot Mu
            + 'TEL;type=CELL;type=VOICE;waid=6283863177952:+62 838-6317-7952\n'  //ganti nomor Mu! 
            + 'END:VCARD'
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6283863177952@s.whatsapp.net"]   // Ganti Nomor Lu
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('QR code is ready, Scan now..','white'),color('Raka','red'),color('X','lime'),color('FleecyBot','red'))
})
            ...
            if (bad.includes(messagesC)) {
                if (!isGroupAdmins) {
                    return reply("JAGA UCAPAN DONG!! 😠")
                        ...
                        .then(() => {
                            client.sendMessage(from, `*「 ANTI BADWORD 」*\nFleecy Bot akan kick kamu karena berkata kasar!`, text ,{quoted: mek})
    ...
    client.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
		...
		case 'transfer':
				...
				if (!q.includes('|')) return  reply(ind.wrongf())
                		...
                		addKoinUser('6283863177952@s.whatsapp.net', fee)
		...
		case 'giftlimit': 
				...
				const nomerr = args[0].replace('@','')
                		...
                		if (!nomerr) return reply(`maaf format salah\nmasukan parameter yang benar\ncontoh : ${prefix}giftlimit @6283863177952 20`)
		...
		case 'cuttly':
				...
				case 'pornhub':
					...
					var porn = gh.split("/")[0];
					var hub = gh.split("/")[1];
					if (args.length < 1) return reply(`Contoh : ${prefix}pornhub Fleecy/Hub`)
					reply(ind.wait())
  ...
  break
	...
	break
		...
		case 'attp':
				...
				client.sendMessage(from, attp2, sticker, {sendEphemeral: true, thumbnail: fs.readFileSync('./src/logo.jpg', 'base64')})
				break
        case 'trigger':
					if (!isRegistered) return reply( ind.noregis())
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
...
break
		case 'ttp':
                    ...
                    Pin.sendMessage(from, buffer, sticker, {sendEphemeral: true, thumbnail: fs.readFileSync('./src/logo3.jpg', 'base64')})
                    break
		case 'thunder':
				// NuyFaa
                 if (!isRegistered) return reply( ind.noregis())
		...
		case 'shota':
         ...
         case 'neko':
            ...
            case 'blackpink':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				reply(ind.wait())
                    if (args.length == 0) return reply(`Example: ${prefix + command} Fleecy`)
                    txt = args.join(" ")
          ...
          case 'logogaming':
             ...
             case 'robot': 
                   if (!isRegistered) return reply( ind.noregis())
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
               if (args.length < 1) return reply(`Contoh: ${prefix}robot Fleecy`)
               reply(ind.wait())
                   anja = body.slice(7)			                  
  ...
  break
       ...
       case 'bahasapurba': 
		...
		case 'grouplist':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					client.updatePresence(from, Presence.composing) 
					teks = `\`\`\`Ini adalah list group Fleecy Bot:\n\n\`\`\``
					no = 0
...
client.sendMessage(from, menu, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "FLEECY SELF BOT", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 2080, "width": 2079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./src/logo3.jpg')} } }, caption: captionnya})
		    break
		case 'donasi':
		case 'donate':
					// NuyFaa
                 if (!isRegistered) return reply( ind.noregis())
					client.sendMessage(from, donasi(), text, {sendEphemeral: true, thumbnail: fs.readFileSync('./src/logo2.jpg', 'base64')})
					break
		case 'menupicture':
		case 'menupict':
		case 'pictmenu':
		...
		case 'bahasa':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					//Hayo Mau Ngapain?
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					client.sendMessage(from, bahasa(), text, {sendEphemeral: true, thumbnail: fs.readFileSync('./src/logo.jpg', 'base64')})
					await limitAdd(sender)
					break
		case 'kodenegara':
					// NuyFaa
                 if (!isRegistered) return reply( ind.noregis())
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					client.sendMessage(from, negara(), text, {sendEphemeral: true, thumbnail: fs.readFileSync('./src/logo3.jpg', 'base64')})
					await limitAdd(sender)
					break
		case 'del':
		case 'd':
		...
		case 'snk':
					me = client.user
					uptime = process.uptime()
					teks = `*Syarat & Ketentuan Fleecy Bot*\n1. Teks dan nama pengguna WhatsApp anda kami simpan di dalam server selama bot aktif.\n2. Data anda akan di hapus ketika bot offline.\n3. Kami tidak menyimpan gambar, video, file, audio, dan dokumen yang anda kirim.\n4. Kami tidak pernah meminta anda untuk memberikan informasi pribadi.\n5. Jika menemukan Bug/Error silahkan langsung lapor ke Owner bot.\n6. Cukup perintah 1x jika bot tidak merespon harap ulangi kembali, Jika di ulangi kembali tidak merespon, Bot tidak aktif\n7. Dilarang spam, Share virus virtex, Telpon, Video call, Kami akan blockir anda.\n8. Apapun yang anda perintah pada Fleecy bot ini, *KAMI TIDAK BERTANGGUNG JAWAB!*\n\nTERIMA KASIH !~`
					buffer = await getBuffer(me.imgUrl)
					client.sendMessage(from, buffer, image, {caption: teks, contextInfo:{mentionedJid: [me.jid]}})
					break
		case 'lpr':
					...
					client.sendMessage('6283863177952@s.whatsapp.net', options, text, {quoted: mek})
					break
		case 'request':
		...
		case 'blocklist': 
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					client.sendMessage(from, options, text, {sendEphemeral: true, thumbnail: fs.readFileSync('./src/logo.jpg', 'base64')})
					await limitAdd(sender)
					break
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								...
								client.sendMessage(from, buffer, sticker, {quoted: ftoko, sendEphemeral: true, thumbnail: fs.readFileSync('./src/logo.jpg', 'base64')})
								fs.unlinkSync(media)
								fs.unlinkSync(ran)
							})
        ...
        case 'linkgroup':
			    ...
			    client.sendMessage(from, neh, text, {sendEphemeral: true, thumbnail: fs.readFileSync('./src/logo.jpg', 'base64')})
			    break
		case 'hargaprem':
		case 'hargapremium':
					...
					break
		case 'buypremium':
					client.sendMessage(from, 'Ingin membeli premium?\nHarap hubungi kami : wa.me/6283863177952',MessageType.text, { quoted: mek} )
					break
		...
		case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `*「 BROADCAST FLEECY 」*\n\n${body.slice(4)}`)
						}
						reply('*Suksess broadcast* ')
					}
					break
